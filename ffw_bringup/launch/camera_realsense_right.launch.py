...
"""Launch only the right wrist RealSense camera for teleoperation depth feedback."""
import copy
import os
import sys
...
local_parameters = [
    ...
    {'name': 'depth_module.color_profile2', 'default': '424,240,6',
    ...
    {'name': 'enable_color2', 'default': 'true',
     'description': 'enable low-rate right wrist color stream for teleoperation feedback'},
    {'name': 'align_depth.enable2', 'default': 'false',
     'description': 'disable depth alignment for low-latency teleoperation'},
    {'name': 'pointcloud.enable2', 'default': 'false',
     'description': 'disable pointcloud generation for low-latency teleoperation'},
    {'name': 'colorizer.enable2', 'default': 'false',
     'description': 'keep RealSense colorizer disabled for teleoperation'},
]
