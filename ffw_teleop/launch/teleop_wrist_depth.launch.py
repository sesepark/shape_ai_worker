...
def make_wrist_camera_launch(condition):
    return IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'enable_depth1': LaunchConfiguration('enable_left_depth'),
...
def generate_launch_description():
    ...
    bandwidth_monitor_node = Node(
        ...
        parameters=[{
            ...
            'usb_wrist_left_depth_enabled': LaunchConfiguration('enable_left_depth'),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'right_color_profile',
            default_value=wrist_high_value('424,240,30', '640,480,30')),
